		<footer id="gFooter">
			...
			<div class="fBox">
				...
				<p class="taLeft">250坪のボディメイクに必要なマシンがすべて揃う究極のジム。運動初心者でも使いやすいく、上級者も納得のマシンラインナップ。地域初の最新ケーブル式マシンも導入。スタジオではバーチャルレッスンを中心にライブレッスンも充実。三重県鈴鹿市、近鉄鈴鹿線三日市駅から徒歩12分。鈴鹿中央道路沿い「鈴鹿グランドボウル１階」駐車場150台完備。</p>
				<p>運営：ワークエル株式会社</p>
				<p style="margin-top: 10px;"><strong>レクシーフィット鈴鹿店ではスタッフ・トレーナーを募集しております。詳しくはご連絡ください。	</strong></p>
				<p><a href="<?php echo home_url();?>/law/">特定商取引法に基づく表記</a></p>
				<p class="copyright">copyright (C) レクシーフィット All right reserved.</p>
			</div>
			<ul class="fixUl">
				<!-- <li><a href="tel:0593256310"><img src="<?php echo get_template_directory_uri(); ?>/img/common/fix_tel.png" alt="tel.059-325-6310" class="pc"><span class="sp">tel.059-325-6310</span></a></li> -->
				<li><a href="https://www.isslim.jp/slim/web/d/index.php/WCM0400E/WCM0400E000/?c=pZtE5qwenv&f=00003" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/common/fix_web.png" alt="WEB入会" class="pc"><span class="sp">WEB入会</span></a></li>
