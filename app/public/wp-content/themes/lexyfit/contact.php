...
define('SUBJECT', '【レクシーフィット鈴鹿店】お問い合わせありがとうございます。');
define('SUBJECT_PRO', '【重要】ホームページよりお問い合わせがありました');
define('TO_ADDR', 'lexyfit.suzuka@gmail.com');

define('FROM_NAME', 'レクシーフィット');

define('FROM_ADDR', 'lexyfit.suzuka@gmail.com');
						...
						<div class="row fuild">
							<div class="privacyBox">
								...
								<ul class="ulbox">
									...
									<li>その他当社の目的として登記されている業務、上記業務に付帯する業務</li>
								</ul>
								<p>●個人情報利用目的</p>
								<ul class="ulbox">
